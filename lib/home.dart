...
Row _buildJournalFooterImages() {
  return Row(
    ...
    children: <Widget>[
      CircleAvatar(
        backgroundImage: AssetImage('assets/img/Lao-Food-Laos-28-X3.jpg'),
        radius: 40.0,
      ),
      CircleAvatar(
        backgroundImage: AssetImage('assets/img/Lao-Food-Laos-44-X3.jpg'),
        radius: 40.0,
      ),
      CircleAvatar(
        backgroundImage:
            AssetImage('assets/img/Frappuccino-ve-kahve-cekirdekleri.jpg'),
        radius: 40.0,
      ),
      SizedBox(
        width: 100.0,
